 ...
 * should be compared to each other, generally for sorting and searching purposes. 
...
public class UnderstandingComparators {
    ...
    public static void main(String[] args) {
        ...
        // Adds some students name, grade, and age to 'students'
        ...
        System.out.println("SORT BY GPA (Lowest First)");
        ...
        System.out.println("SORT BY AGE (Youngest First)");
        Collections.sort(students, new StudentAgeComparator());
        printStudents(students);
        
        System.out.println("SORT BY AGE (Oldest First)");
        Collections.sort(students, new StudentAgeComparatorOld());
        printStudents(students);
    }
