...
public class QuizAverage {
    ...
    public static void main(String[] args) {
        ...
        if (!(count == 0)) { // Added brackets to isolate exclamation from expression // Added an extra '=' sign
