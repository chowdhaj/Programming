...
package lesson.activities.dungeonhackcriticalhit;

import lesson.activities.dungeonhackcriticalhit.*;
...
public class DungeonHackRun {
    ...
    public static void main(String[] args) {
        ...
        if (roll >= monster.armorClass()) {
            ...
            if (roll == 20) { // Fixed the comparative operator
                damage *= 2; // Fixed the critical hit multiplier
        ...
        if (monster.isDead()) { System.out.printf(", killing it"); } // Moved this from the top to the very bottom
