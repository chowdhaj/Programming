...
public class Card {    
    ...
    /**
     * Used to sort by suit then card rank (aka hearts, spades, pitch)
    ...
    public boolean lessThanBySuitThenRank(Card c) {
         ...
         *  return comparison smaller rank (this.rank < c.rank)
         * else
    ...
    /**
     * Used to sort by rank, then by suit. (aka  old maid, crazy eights)
     * @param c the card to compare to
