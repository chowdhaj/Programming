...
package lesson.activities.playingcardsexample;
...
public class PlayingCardsRun {
    ...
    public static void main(String[] args) {
    	...
    	//NOTE: This code is here for reference only. You should not be running this code but rather executing the unit tests in CardTest.java
    	
    	Random rnd = new Random();
    	Card cardOne = new Card(rnd.nextInt(52));
    	Card cardTwo = new Card(rnd.nextInt(52));
    	System.out.println(cardOne + "\t" + cardTwo);
    	
    	System.out.printf("\nCard One isBlack? %s\n\n", cardOne.isBlack());
    	System.out.printf("Card One isFace? %s\n\n", cardOne.isFace());
    	System.out.printf("Card One sameColor As Card Two? %s\n\n", cardOne.sameColor(cardTwo));    	
    }
}

//isBlack, isFace, sameColor