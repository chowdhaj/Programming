package lesson.activities.deckofplayingcards;
...
public class Deck {
    ...
    private Card topCard;				// Assigns the 0th element in ArrayList
     ...
     */    
    public int cardCount() { return card_deck.size(); } // Returns the size of the deck
