...
public class EZTipCalc {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("\n===== Tip Calc =====\n");
        System.out.printf("Bill Amount.. %3.2f\n", tc.getBillAmount()); // Changed 'tc.getTipPct()' to 'tc.getBillAmount(0)'
        System.out.printf("Tip Pct...... %3.2f\n", tc.getTipPct()); // Changed 'tc.total()' to 'tc.getTipPct()'
        System.out.printf("Tip Amount... %3.2f\n", tc.tipAmount()); // Changed 'tc.tipAmount(9)' to 'tc.tipAmount()'
        System.out.printf("Bill Total... %3.2f\n", tc.billTotal()); // Changed 'tc.billTotal' to 'tc.billTotal'
