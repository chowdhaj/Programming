...
public class Deck {
    ...
    public void sortRankFirst() {
        ...
        Collections.sort(this.card_deck, new CardComparatorRankFirst()); // Added the keyword 'new' // Added 'card_deck' to 'this' 
    }
    ...
    public void sortSuitFirst() {
        // Use the comparator to sort the collection of cards
        Collections.sort(card_deck, new CardComparatorSuitFirst()); // Changed Comparator to 'SuitFirst'
    }
