package lesson.activities.tictactoefullgame;
...
public class Board {
     ...
     */
    public boolean Full() { // This method checks to see if the board is full by comparing board indices to Marker.EMPTY
    	int boardCounter = 0;
    	for (int i = 0; i < 3; i++) {
    		for (int j = 0; j < 3; j ++) {
